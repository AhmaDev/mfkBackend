...
router.delete(`/${tableName}/:id`, function (req, res, next) {
  connection.query(
    `DELETE FROM locationImage WHERE locationId = ${req.params.id}`,
  );
  connection.query(`DELETE FROM payment WHERE locationId = ${req.params.id}`);
  connection.query(
    `DELETE FROM paymentCut WHERE locationId = ${req.params.id}`,
  );
  connection.query(
    `DELETE FROM paymentCutImage WHERE locationId = ${req.params.id}`,
  );
  connection.query(
